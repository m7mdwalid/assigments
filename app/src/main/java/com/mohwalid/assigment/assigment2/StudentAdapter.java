...
public class StudentAdapter extends RecyclerView.Adapter<StudentAdapter.StudentVh> {
    ...
    class StudentVh extends RecyclerView.ViewHolder {
        ...
        private TextView age_student;
        private TextView degree_student;
        private TextView level_student;

        public StudentVh(@NonNull View itemView) {
            super(itemView);
            name_student = itemView.findViewById(R.id.tv_name_student);
            age_student = itemView.findViewById(R.id.tv_age_student);
            degree_student = itemView.findViewById(R.id.tv_degree_student);
            level_student = itemView.findViewById(R.id.tv_level_student);
        }

        public void setData(final Student student) {
            name_student.setText(student.getName());
            age_student.setText(student.getAge());
            degree_student.setText(student.getDegree());
            level_student.setText(student.getLevel());
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(itemView.getContext(), StudentInfoActivity.class);
